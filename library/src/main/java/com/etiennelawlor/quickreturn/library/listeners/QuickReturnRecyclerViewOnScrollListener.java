...
import com.etiennelawlor.quickreturn.library.utils.HighlightNotif;
...
public class QuickReturnRecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    private HighlightNotif highlightNotif;
    ...
    private QuickReturnRecyclerViewOnScrollListener(Builder builder) {
        ...
        highlightNotif = builder.highlightNotif;
    }
    // endregion
...
//        Log.d("", "onScrolled() : diff - "+diff);
        ...
        if (diff != 0) {
            switch (mQuickReturnViewType) {
                case HEADER:
                    ...
                    Log.v("scrollchj","value = "+(recyclerView.getHeight()-(mMinHeaderTranslation-mHeader.getHeight()))+"");
                    Log.v("scrollchj","value of recy height = "+(recyclerView.getHeight()));
                    Log.v("scrollchj","value of innov = "+(recyclerView.getHeight()-mHeaderDiffTotal)+"");


                    ViewGroup.LayoutParams params=recyclerView.getLayoutParams();
                    ViewGroup.MarginLayoutParams params1=(ViewGroup.MarginLayoutParams)recyclerView.getLayoutParams();
                    recyclerView.setTranslationY(mHeaderDiffTotal-20);
                    //recyclerView.animate().translationY(mHeaderDiffTotal).start();
                    params1.bottomMargin = mHeaderDiffTotal;
        ...
        mPrevScrollY = scrollY;
            ...
            highlightNotif.highlightTheItem(null);
    }
    ...
    public static class Builder {
        ...
        public Builder setHighlightNotif(HighlightNotif highlightNotif) {
            this.highlightNotif = highlightNotif;
            return this;
        }
